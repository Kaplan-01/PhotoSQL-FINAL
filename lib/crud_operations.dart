...
class DBHelper {
  ...
  static const String DB_NAME = 'students06.db';
  ...
  _onCreate(Database db, int version) async {
    await db.execute(
        "CREATE TABLE $TABLE ($Id INTEGER PRIMARY KEY AUTOINCREMENT, $PHOTO_NAME TEXT, $NAME TEXT, $APP TEXT, $APPP TEXT, $TELEF TEXT, $CORREO TEXT, $MATRICULA TEXT)");
  }
  ...
  Future<List<Student>> getStudents() async {
    ...
    List<Map> maps = await dbClient
        .query(TABLE, columns: [Id, PHOTO_NAME, NAME, APP, APPP, TELEF, CORREO, MATRICULA]);
